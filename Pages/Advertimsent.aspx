<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Advertimsent.aspx.cs" Inherits="Pages_Default" EnableEventValidation="false" %>
    ...
    <form id="form1" runat="server">
            ...
            <ContentTemplate>
                ...
                <nav class="navbar navbar-inverse navbar-fixed-top">
                    <div class="navbar-header">
                        <a class="navbar-brand " href="Home.aspx">3alyamen</a>
        ...
        <div class="row" style="padding: 10px">
            <div class="col-md-4">
                ...
                <div class="btn-group" id="divViewMode" role="group" style="margin-top: 5px" aria-label="">
