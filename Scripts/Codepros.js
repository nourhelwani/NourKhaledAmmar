(function (window, google, list, $) {
    ...
    var Codepros = (function () {
        ...
        function Codepros(element, mapOption) {
            ...
            //Remember To Provide a Style for a Clusterer
        ...
        Codepros.prototype = {
            ...
            ClearMarkers: function () {
                ...
                for (var i = 0; i < this.markers.items.length; i++) {
                    se,f.markers.items[i].setMap(null);
                }
            },
            ...
            GetWeather:function(){
                $.getJSON('http://api.openweathermap.org/data/2.5/weather?q=Damascus,sy', function (response) {
